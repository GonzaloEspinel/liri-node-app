        ...
        request(queryUrl, function(err, response, body) {
            if (JSON.parse(body).Error == "Movie not found!") {
               ...
               //// FunctionMovie("The Godfather");
                ...
                //// * Rating of the movie.
                var theGod = JSON.parse(body).Ratings;
                if (theGod[1] != undefined) {
                    console.log("The Godfather rating is: ----" + theGod[1].Value);
